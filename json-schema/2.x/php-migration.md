...
In 2.0 you should use the [validation](php-validator.html#data-validation) method, which is smart enough to detect
...
or `null` if data is valid. We recommend to stick with the `validation` method.
